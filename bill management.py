...
Label(f,font=("Lucida calligraphy",15,'bold'),text="Idli = Rs.30/plate",fg="black",bg="lightgreen").place(x=10,y=110)
Label(f,font=("Lucida calligraphy",15,'bold'),text="tea = Rs.20/cup",fg="black",bg="lightgreen").place(x=10,y=140)
Label(f,font=("Lucida calligraphy",15,'bold'),text="Coffee = Rs.25/cup",fg="black",bg="lightgreen").place(x=10,y=170)
Label(f,font=("Lucida calligraphy",15,'bold'),text="Pancake = Rs.15/pack",fg="black",bg="lightgreen").place(x=10,y=200)
Label(f,font=("Lucida calligraphy",15,'bold'),text="Juice = Rs.20/glass",fg="black",bg="lightgreen").place(x=10,y=230)
Label(f,font=("Lucida calligraphy",15,'bold'),text="Eggs = Rs.7/each",fg="black",bg="lightgreen").place(x=10,y=260)

f2=Frame(root,bg="lightyellow",highlightbackground="black",highlightthickness=1,width=300,height=370)
f2.place(x=705,y=118)

bill=Label(f2,text="Bill",font=("calibri",20),bg="lightyellow")
bill.place(x=120,y=10)

f1=Frame(root,bd=5,height=370,width=300,relief=RAISED)
f1.place(x=333,y=118)
...
lbl_pancake.grid(row=5,column=0)
...
entry_pancake.grid(row=5,column=1)
